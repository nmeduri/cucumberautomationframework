...
public class Your_Email_Has_Been_Verified_Page extends PageObject {
	...
	public void display_Your_Page_Has_been_Verified() throws Exception {
		...
		$display(ExpectedConditions.visibilityOfElementLocated($By(Loc.XPATH, testContext.getPageObjectManager().getYourEmailHasBeenVerifiedLocator().get_Your_Email_Has_Been_Verified())), 50);
	...
	public void Click_Continue_Button_Email_Verification_Page() throws Exception {
		//testContext.getPageObjectManager().getPageObject(PageObject.getDriver()).switchWindow();
		$click(ExpectedConditions.visibilityOfElementLocated($By(Loc.XPATH, testContext.getPageObjectManager().getYourEmailHasBeenVerifiedLocator().get_Continue_Button_Email_Verification_Page())),40);
	}
}
