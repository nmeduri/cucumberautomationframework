...
public class AEM_Common_Page extends PageObject {
	...
	public void clickArrowIcon() throws Exception {
		...
		$click(ExpectedConditions.visibilityOfElementLocated(
				$By(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getArrowSignIn())), 3);

	}

	/** enter username */
	public void enterUsername() throws Exception {
		$enterData($(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getAEMUserName()),
				FileReaderManager.getInstance().getAEMDataReader().get_AEM_Admin_User());
	}

	/** enter password */
	public void enterPassword() throws Exception {
		$enterData($(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getAEMPassword()),
				FileReaderManager.getInstance().getAEMDataReader().get_AEM_Admin_Password());
	}
	...
	public void clickCloseButton() throws Exception {
		$click(ExpectedConditions.visibilityOfElementLocated(
				$By(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getCloseButton())), 5);
	}
	...
	public void clickEditIcon() throws Exception {
		...
		// $findElement(By.xpath(testContext.getPageObjectManager().getAEMCommonPageLocator().getEditButton())));
		$click(ExpectedConditions.presenceOfElementLocated(
				By.xpath(testContext.getPageObjectManager().getAEMCommonPageLocator().getEditButton())), 25);
		...
		try {
			$clickFindElement(
					ExpectedConditions.visibilityOfElementLocated(By
							.xpath(testContext.getPageObjectManager().getAEMCommonPageLocator().getConfigureButton())),
					5);
		} catch (Exception e) {
	...
	public void clickOnPageInformation() throws Exception {
		((JavascriptExecutor) PageObject.getDriver()).executeScript("arguments[0].click();",
				$findElement(
						By.xpath(testContext.getPageObjectManager().getAEMCommonPageLocator().get_Page_Information())),
				20);
	}
	...
	public void clickOnPublishPage() throws Exception {
		$click(ExpectedConditions.visibilityOfElementLocated(
				By.xpath(testContext.getPageObjectManager().getAEMCommonPageLocator().get_Publish_Page())), 5);
		try {
			if ($display($$$$(Loc.XPATH,
					testContext.getPageObjectManager().getAEMCommonPageLocator().get_SelectAll_Checkbox(), 10))) {
	...
	public void clickPreviewButton() throws Exception {
		...
		$display(ExpectedConditions.visibilityOfElementLocated(
				$By(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getPreviewButton())), 5);
		$click(ExpectedConditions.visibilityOfElementLocated(
				$By(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getPreviewButton())), 5);
	}
	...
	public void clickEditButton() throws Exception {
		...
		$display(
				ExpectedConditions.visibilityOfElementLocated(
						$By(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getEditButton())),
				20);
		$click(ExpectedConditions.visibilityOfElementLocated(
				$By(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getEditButton())), 40);
	}
	
	/** This function clicks on Edit button */
	public void clickDropDownIcon() throws Exception {
		Thread.sleep(3000);
		$display(
				ExpectedConditions.visibilityOfElementLocated(
						$By(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getDropDownButton())),
				20);
		$click(ExpectedConditions.visibilityOfElementLocated(
				$By(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getDropDownButton())), 40);
	}
	...
	public void clickOnThePreviewButton() throws Exception {
		Thread.sleep(5000);
		$display(ExpectedConditions.visibilityOfElementLocated(
				$By(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getPreviewButton())), 20);
		$click(ExpectedConditions.visibilityOfElementLocated(
				$By(Loc.XPATH, testContext.getPageObjectManager().getAEMCommonPageLocator().getPreviewButton())), 20);
