...
public final class Adobe_Regression_Web_Internet_Explore_Runner extends BaseClass {
	...
	public static void main(String[] args) throws Throwable {
		Adobe_Regression_Web_Internet_Explore_Runner ls = new Adobe_Regression_Web_Internet_Explore_Runner();
