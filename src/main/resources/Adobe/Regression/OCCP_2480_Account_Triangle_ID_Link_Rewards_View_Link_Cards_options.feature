...
@RegressionTest @WideScreen
	...
	@RegressionTest @WideScreen
	Scenario: TC-2007,2015,2016,1993 Verify hide the link screen option on the Link Card screen when -Email Validation
	Given sign up url is available
	Then sign up page is displayed
	And user enter email
	And user enter password
	...
	Scenario: TC-1995 Verify the display of tool tip for the "Do not show me this again" toggle button
  Given login url is available
	When enter email detail
	And user enter password
	And user click on sign in button
	...
	@RegressionTest @WideScreen @MobileView
	Scenario: TC-2009,2017 Verify the display of tool tip for the "Do not show me this again" toggle button -Link Card Screen on Widescreen
  Given login url is available
	When enter email detail
	And user enter password
	And user click on sign in button
