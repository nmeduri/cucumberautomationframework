Feature: OCCP-871 PDP Installations
	...
	@RegressionTest @MobileView
	Scenario: TC-1303 Verify the functionality of the PDP page when a product is eligible for service installation (Mobile)
	Given pdp url is available
    When pdp page is displayed for the product
    Then Get it installed indicator is displayed on the pdp
    Then message available at checkout is displayed on the pdp
	...
	Scenario: TC-1305 Verify the functionality of the PDP page when a product is eligible for service installation (Widescreen) 
	Given pdp url is available
    When pdp page is displayed for the product
    Then Get it installed indicator is displayed on the pdp
    Then message available at checkout is displayed on the pdp
