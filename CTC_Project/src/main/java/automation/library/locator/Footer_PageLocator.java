...
public class Footer_PageLocator {
	...
	String customSupportSection = Property.getProperty(Constant.OR_FILE, "customSupportSection");
	String servicesAndSolutionsSection = Property.getProperty(Constant.OR_FILE, "servicesAndSolutionsSection");
	String aboutUsSection = Property.getProperty(Constant.OR_FILE, "aboutUsSection");
	String legalSection = Property.getProperty(Constant.OR_FILE, "legalSection");
	String goToFooter = Property.getProperty(Constant.OR_FILE, "goToFooter");
	String orderStatus = Property.getProperty(Constant.OR_FILE, "orderStatus");
	String pickupAndDelivery = Property.getProperty(Constant.OR_FILE, "pickupAndDelivery");
	...
	String installationAndAssembling = Property.getProperty(Constant.OR_FILE, "installationAndAssembling");
	String autoServiceCenter = Property.getProperty(Constant.OR_FILE, "autoServiceCenter");
	String loanATool = Property.getProperty(Constant.OR_FILE, "loanATool");
	String roadsideAssitance = Property.getProperty(Constant.OR_FILE, "roadsideAssitance");
	String giftCards = Property.getProperty(Constant.OR_FILE, "giftCards");
	String testedForLife = Property.getProperty(Constant.OR_FILE, "testedForLife");
	String giftRegistry = Property.getProperty(Constant.OR_FILE, "giftRegistry");
	String aboutCanadianTire = Property.getProperty(Constant.OR_FILE, "aboutCanadianTire");
	String careers = Property.getProperty(Constant.OR_FILE, "careers");
	String aboutTriangleId = Property.getProperty(Constant.OR_FILE, "aboutTriangleId");
	String helpAndFaqs = Property.getProperty(Constant.OR_FILE, "helpAndFaqs");
	String ourBrands = Property.getProperty(Constant.OR_FILE, "ourBrands");
	String flyerSignUp = Property.getProperty(Constant.OR_FILE, "flyerSignUp");
	String sustainability = Property.getProperty(Constant.OR_FILE, "sustainability");
	String privacyPolicyLink = Property.getProperty(Constant.OR_FILE, "privacyPolicyLink");
	String termsAndConditionsLink = Property.getProperty(Constant.OR_FILE, "termsAndConditionsLink");
	String siteMapLink = Property.getProperty(Constant.OR_FILE, "siteMapLink");
	String accessabilityLink = Property.getProperty(Constant.OR_FILE, "accessabilityLink");
	String pricingPolicy = Property.getProperty(Constant.OR_FILE, "pricingPolicy");
	String customSupportPlusButton = Property.getProperty(Constant.OR_FILE, "customSupportPlusButton");
	String servicesAndSolutionsPlusButton = Property.getProperty(Constant.OR_FILE, "servicesAndSolutionsPlusButton");
	String aboutUsPlusButton = Property.getProperty(Constant.OR_FILE, "aboutUsPlusButton");
	String legalPlusButton = Property.getProperty(Constant.OR_FILE, "legalPlusButton");
	String minusButton = Property.getProperty(Constant.OR_FILE, "minusButton");
	String expandedSubsectionlinks = Property.getProperty(Constant.OR_FILE, "expandedSubsectionlinks");
	String userManual = Property.getProperty(Constant.OR_FILE, "userManual");
	...
	String downloadTheApp = Property.getProperty(Constant.OR_FILE, "downloadTheApp");
	...
	String appstoreLogo=Property.getProperty(Constant.OR_FILE, "appstoreLogo");
	String androidPlayStoreLogo = Property.getProperty(Constant.OR_FILE, "androidPlayStoreLogo");
	String iosAppStoreLogo = Property.getProperty(Constant.OR_FILE, "iosAppStoreLogo");
	...
	/**
	 * gets Locator - appstore Logo
	 * 
	 */

	public String get_appstore_Logo() {
		return appstoreLogo;
	}
	...
	/**
	 * gets Locator - download the app in footer
	 * 
	 */

	public String get_downloadTheApp() {
		return downloadTheApp;
	}

	/**
	 * gets Locator - Pickup and Delivery Text
	 * 
	 */
	...
	/**
	 * get Locator - Android Playstore logo
	 */
	public String get_Android_PlayStore_Logo() {
		return androidPlayStoreLogo;
		
	}
	
	 /** gets Locator - IOS Playstore logo
	 * 
	 */
