...
public class Link_Your_Existing_Triangle_Rewards_Card_PageLocator {
	...
	String cancelButtonExistingCardFED = Property.getProperty(Constant.OR_FILE, "cancelButtonExistingCardFED");
	...
	String activeValidationErrorTextFED = Property.getProperty(Constant.OR_FILE, "activeValidationErrorTextFED");
	...
	/**
	 * gets Locator - Cancel button in FED
	 * 
	 */
	
	public String get_Cancel_ButtonFED() {
		return cancelButtonExistingCardFED;
	}
	...
	public String get_Active_Error_Text() {
		return activeValidationErrorTextFED;
	}
