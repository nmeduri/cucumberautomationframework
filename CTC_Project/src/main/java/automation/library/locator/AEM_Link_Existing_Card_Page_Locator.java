...
public class AEM_Link_Existing_Card_Page_Locator {
	...
	String activeValidationErrorImgAEM = Property.getProperty(Constant.OR_FILE, "activeValidationErrorImgAEM");
...
<<<<<<< HEAD
	...
	/**
	 * gets Locator - Error Image in AEM
	 * 
	 */
	
	public String get_Error_Image_AEM() {
		return activeValidationErrorImgAEM;
	}
